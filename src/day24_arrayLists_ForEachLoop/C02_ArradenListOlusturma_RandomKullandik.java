...
public class C02_ArradenListOlusturma_RandomKullandik {
    public static void main(String[] args) {
        ...
        while (sayiListesi.size()<200){
            ...
            sayi=rnd.nextInt(1000); //en fazla 1000 sayisi uretsin demek
...
//--------Yukarida olusturulan Listteki sayilari radom ile tahmin etme-------------------------

        boolean bildiMi=false;
        int tahminSayisi=1;
        Scanner scan=new Scanner(System.in);

        while (!bildiMi){//bildiMi==false ile ayni anlama gelir
