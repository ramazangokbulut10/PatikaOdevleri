...
public class Fp1 {
    public static void main(String[] args) {
        ...
        1) (Lambda Function Programming) Java 8 ile kullanılmaya başlanmıştır.
        2)  Function Programming'de "Ne yapılacak" (What to do ?) üzerine yoğunlaşılır.
        3)  Struct bir programdır, nasıl yapılacağı üzerine yoğunlaşır.
        4)  Function Programming Arrays ve Collections ile kullanılır.
        5)  "entrySet() methodu ile Map, Set'e dönüştürülerek Function Programming'de kullanılabilir.
